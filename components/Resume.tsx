  ...
  return (
    <SectionContainer id="resume">
      <div className="flex flex-col items-center mb-12 text-center">
        <span className="text-primary font-mono text-sm tracking-wider uppercase mb-2">Qualifications</span>
        <h2 className="text-3xl md:text-5xl font-bold text-white">My Resume</h2>
      </div>
