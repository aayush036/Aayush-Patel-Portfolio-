  ...
  return (
    <SectionContainer id="projects">
      <div className="flex flex-col items-center mb-16 text-center">
        <span className="text-primary font-mono text-sm tracking-wider uppercase mb-2">My Work</span>
        <h2 className="text-3xl md:text-5xl font-bold text-white">Featured Projects</h2>
        <p className="text-gray-400 mt-4 max-w-lg">
          A selection of projects that I've built to demonstrate my skills and passion for development.
        </p>
      </div>
