      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-1 md:order-2">
          ...
          {skills && skills.length > 0 && (
            <div className="mt-8">
              <h3 className="text-sm font-bold text-white mb-4 uppercase tracking-wider">Tech Stack</h3>
              <div className="flex flex-wrap gap-3">
                {skills.map((skill) => (
                  <div 
                    ...
                    title={skill.name}
                  >
                    <i className={`${skill.iconClass} text-2xl text-gray-400 group-hover:text-primary transition-colors duration-300`}></i>
