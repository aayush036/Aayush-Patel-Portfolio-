...
export const portfolioData: ProfileData = {
  ...
  resumeUrl: "https://drive.google.com/file/d/1euuAtVPGuVdK6Rr0dE6PYr5JwfpGcMgO/preview", // Replace with your actual PDF link
  about: {
    profileImage: "https://picsum.photos/400/400", // Replace with your photo URL
    text: [
  "I'm Aayush Patel, a developer focused on full-stack web development and blockchain technologies. I enjoy building clean, scalable applications using modern JavaScript frameworks.",
  "I'm also exploring blockchain fundamentals, smart contracts, and decentralized systems. I aim to write clear, structured code while deepening my understanding of both web technologies and blockchain development.",
  "With experience in teaching, problem-solving, and continuous self-learning, I strive to grow as a developer and always stay curious."
]
